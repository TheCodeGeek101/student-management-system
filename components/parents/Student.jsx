...
import ReferenceCode from './ReferenceCode'; // Import your ReferenceCode component here
...
const Student = ({ setAddStudentModal }) => {
  ...
  const [studentData, setStudentData] = useState(createInitialFormState(fieldConfig));
  ...
  const onSubmit = async (e) => {
    ...
    try{
     ...
     console.erro("error encountered is:" +error);
    }
    finally{
        //  setAddStudentModal(false);
        await setShowReferenceCode(true);
    }
  };
  ...
  return (
    <div>
      ...
      {showReferenceCode && <ReferenceCode setShowReferenceCode={setShowReferenceCode} id={referenceCode} />}
    </div>
  );
};
