...
const DashboardNavbar = ({pageName}) => {
  ...
  return (
    ...
    <motion.nav
      ...
      className="lg:ml-96 sticky bg-white/30 flex flex-wrap items-center justify-between px-0 py-2 mx-6 transition-all ease-in shadow-none duration-250 rounded-2xl lg:flex-nowrap lg:justify-start"
      navbar-main
      navbar-scroll="false"
    >
